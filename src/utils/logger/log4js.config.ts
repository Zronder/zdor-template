...
import { LOGGER_PATH } from '@config/index'
...
const log4jsConfig = {
    appenders: {
        ...
        access: {
            ...
            filename: `${LOGGER_PATH}/access/access.log`, // 日志文件名，会命名为：access.20200320.log
        ...
        app: {
            type: 'dateFile',
            filename: `${LOGGER_PATH}/app-out/app.log`,
            alwaysIncludePattern: true,
            layout: {
                type: 'pattern',
                pattern:
        ...
        errorFile: {
            type: 'dateFile',
            filename: `${LOGGER_PATH}/errors/error.log`,
            alwaysIncludePattern: true,
            layout: {
                type: 'pattern',
                pattern:
